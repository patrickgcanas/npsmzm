...
function buildEmailHtml(clientName, inviteUrl, requestOrigin) {
  ...
  const signature = `
    <br/>
    <table cellpadding="0" cellspacing="0" border="0" style="width:600px;border-radius:6px;overflow:hidden;font-family:'Montserrat',Arial,sans-serif;">
      <tr>
        <td width="168" style="background-color:#ccd5d3;padding:14px;text-align:center;vertical-align:middle;">
          <img src="${logoUrl}" alt="MZM Wealth" width="136" height="136" style="display:block;margin:0 auto;" />
        </td>
        <td style="background-color:#1c3d33;padding:22px 32px;vertical-align:middle;">
          <p style="margin:0 0 16px 0;font-family:'Montserrat',Arial,sans-serif;font-size:22px;font-weight:800;color:#ffffff;letter-spacing:3px;text-transform:uppercase;line-height:1.1;">ARIANE SICILIANO</p>
          <p style="margin:0 0 5px 0;font-family:'Montserrat',Arial,sans-serif;font-size:14px;font-weight:400;color:#ffffff;letter-spacing:0.3px;">11 97379-5858</p>
          <p style="margin:0 0 16px 0;font-family:'Montserrat',Arial,sans-serif;font-size:15px;font-weight:700;color:#ffffff;letter-spacing:0.2px;">ariane.siciliano@mzmwealth.com</p>
          <p style="margin:0;font-family:'Montserrat',Arial,sans-serif;font-size:11px;font-weight:400;color:rgba(255,255,255,0.6);line-height:1.8;">Av. Brig. Faria Lima, 1188 - cj. 131<br/>Pinheiros - CEP: 01451-001</p>
        </td>
      </tr>
    </table>`;
